                ...
                <div className="relative h-full rounded-xl border-[0.75px] border-gray-800 bg-black overflow-hidden p-4 flex flex-col items-start">
                  ...
                  <div className="w-full min-h-[120px] flex flex-col justify-start">
                    <h2 className="text-white mt-4 text-sm font-light z-20 relative">
                      Eliminate frustration and financial uncertainty caused by
                      flight delays by providing instant, automated USDC payouts
                      through oracle-verified smart contracts.
                    </h2>
                  </div>
                </div>
              </div>
            ...
            <li className="list-none">
              <div className="relative h-[500px] rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                ...
                <div className="relative h-full rounded-xl border-[0.75px] border-gray-800 bg-black overflow-hidden p-4 flex flex-col items-start">
                  ...
                  <div className="w-full min-h-[120px] flex flex-col justify-start">
                    <h2 className="text-white mt-4 text-sm font-light z-20 relative">
                      We leverage Algorand blockchain and oracle technology to
                      revolutionize flight delay insurance with instant,
                      automated payouts.
                    </h2>
                  </div>
                </div>
            ...
            <li className="list-none">
              <div className="relative h-[500px] rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                ...
                <div className="relative h-full rounded-xl border-[0.75px] border-gray-800 bg-black overflow-hidden p-4 flex flex-col items-start">
                  ...
                  <div className="w-full min-h-[120px] flex flex-col justify-start">
                    <h2 className="text-white mt-4 text-sm font-light z-20 relative">
                      All policy terms, oracle checks, and payouts are auditable
                      on-chain. Complete transparency, zero opacity—you can
                      verify everything.
                    </h2>
                  </div>
                </div>
            ...
            <li className="list-none">
              <div className="relative h-[500px] rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                ...
                <div className="relative h-full rounded-xl border-[0.75px] border-gray-800 bg-black overflow-hidden p-4 flex flex-col items-start">
                  ...
                  <div className="w-full min-h-[120px] flex flex-col justify-start">
                    <h2 className="text-white mt-4 text-sm font-light z-20 relative">
                      Algorand's high throughput enables sub-second USDC payouts
                      when delays occur. No waiting, no bureaucracy—just instant
                      protection.
                    </h2>
                  </div>
                </div>
      ...
      >
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-neutral-300 max-w-3xl mx-auto">
              Real-time visualization of active flight delay insurance policies
          ...
          <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
            <div className="relative">
              <ul className="relative z-10 grid grid-cols-6 gap-3">
                    ...
                    <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-xl border-[0.75px] border-gray-800 bg-black p-6 shadow-sm">
                      <CardContent className="relative m-auto size-fit pt-6">
                        <div className="relative flex h-24 w-56 items-center">
                          <svg
                            className="text-neutral-600 absolute inset-0 size-full"
                            viewBox="0 0 254 104"
                            fill="none"
                  ...
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    ...
                    <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-xl border-[0.75px] border-gray-800 bg-black p-6 shadow-sm">
                      <CardContent className="pt-6">
                        <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-gray-800 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800/50">
                          <svg
                            className="m-auto h-fit w-24 text-emerald-400"
                            viewBox="0 0 212 143"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                        ...
                        <div className="relative z-10 mt-6 space-y-2 text-center">
                          ...
                          <p className="text-neutral-300">
                            Oracles or flight data APIs provide real-time,
                            multi-source flight data for reliable delay
                            verification.
                          </p>
                        </div>
                      </CardContent>
                ...
                {/* Card 3: Transparent On-Chain - Large Center */}
                <li className="col-span-full list-none sm:col-span-3 lg:col-span-2">
                  <div className="relative h-full rounded-[1.25rem] border-[0.75px] border-gray-800 p-2 md:rounded-[1.5rem] md:p-3">
                    <GlowingEffect
                      spread={40}
                    ...
                    <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-xl border-[0.75px] border-gray-800 bg-black p-6 shadow-sm">
                      <CardContent className="pt-6">
                        ...
                        <div className="relative z-10 mt-14 space-y-2 text-center">
                          ...
                          <p className="text-neutral-300">
                            All policy terms, oracle checks, and payouts are
                            auditable on-chain. Complete transparency.
                          </p>
                        </div>
                      </CardContent>
                    </div>
                ...
                {/* Card 4: Community Ownership - Wide */}
                      ...
                      <CardContent className="grid pt-6 sm:grid-cols-2">
                        <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                          <div className="relative flex aspect-square size-12 rounded-full border border-gray-800 before:absolute before:-inset-2 before:rounded-full before:border before:border-gray-800/50">
                            <Globe
                              className="m-auto size-5 text-indigo-400"
                              strokeWidth={1}
                            />
                          </div>
                          <div className="space-y-2">
                            ...
                            <p className="text-neutral-300">
                              Democratic governance and surplus redistribution
                              align incentives with travelers.
                            </p>
                          </div>
                        </div>
                        <div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-gray-800 p-6 py-6 sm:ml-6">
                          <div className="absolute left-3 top-2 flex gap-1">
                            <span className="block size-2 rounded-full border border-gray-800 bg-gray-800/50"></span>
                            <span className="block size-2 rounded-full border border-gray-800 bg-gray-800/50"></span>
                            <span className="block size-2 rounded-full border border-gray-800 bg-gray-800/50"></span>
                          </div>
                          <svg
                            className="w-full sm:w-[150%] text-purple-500"
                            viewBox="0 0 366 231"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                      ...
                      <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                        <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-neutral-300">
                              Protect flights worldwide with instant, automated
                              coverage.
                            </p>
                          </div>
                        </div>
