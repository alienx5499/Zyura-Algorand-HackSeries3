  ...
  return (
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8">
      ...
      <div className="glass relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-purple-700 text-2xl font-extrabold text-white shadow-md">
              <svg
          ...
          <p className="text-white mb-6 max-w-xs text-center text-sm md:text-left">
            ...
            Purchase parametric cover at checkout. When delays occur,
            oracle-verified data triggers instant automated USDC payouts.
          </p>
      ...
      <div className="text-gray-300 relative z-10 mt-10 text-center text-xs">
        <span>
          &copy; {new Date().getFullYear()} ZYURA. All rights reserved. Built by{" "}
          <a
