...
const defaultValues: AboutUsProps["values"] = [
  {
    title: "Innovation",
    description:
      "We leverage Algorand and oracle technology to revolutionize flight delay insurance with instant, automated payouts.",
    icon: "Lightbulb",
  },
  {
    title: "Transparency",
  ...
  },
  {
    title: "Fairness",
    description:
      "Democratic governance and surplus redistribution align incentives with travelers. Community-owned, for the community.",
    icon: "Sparkles",
  },
  {
    title: "Speed",
    description:
      "Algorand enables fast USDC payouts when delays occur. No waiting, no bureaucracy—just instant protection.",
    icon: "Globe",
  },
];
...
export default function AboutUs1() {
  const aboutData = {
    title: "About ZYURA",
    subtitle:
      "Instant, fair, community-owned flight delay insurance on Algorand—transforming travel protection with automated smart contracts.",
    mission:
      "Our mission is to eliminate the frustration and financial uncertainty caused by flight delays by providing instant, automated USDC payouts through oracle-verified smart contracts, making travel protection fair, transparent, and community-governed.",
    vision:
      "We envision a world where flight delay compensation is instant, transparent, and community-owned—no paperwork, no waiting, no opacity. Every traveler deserves fast, fair protection.",
    ...
    <section className="relative w-full overflow-hidden pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-gray-300 mt-6 text-xl">{aboutData.subtitle}</p>
        </motion.div>
