...
import { ArrowRight, Mail, Brain, Rocket, Zap } from "lucide-react";
...
export default function CardFlip({
  ...
  subtitle = "Revolutionize your finances",
  description = "Connect your Gmail and let our AI automatically categorize your expenses, track your budget, and provide real-time insights.",
  features = [
    "Gmail Integration",
    "AI Categorization",
    "Live Dashboard",
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className={cn(
                    ...
                    "from-purple-500 via-purple-600 to-purple-700 bg-gradient-to-br",
                    "flex items-center justify-center",
                    "shadow-purple-500/25 shadow-lg",
                    "animate-pulse",
          ...
          <div className="relative z-10 flex-1 space-y-5">
            <div className="space-y-2">
              <div className="mb-2 flex items-center gap-2">
                <div className="from-purple-500 via-purple-600 to-purple-700 flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br">
            ...
            <div className="space-y-2.5">
              {features.map((feature, index) => {
                const icons = [Mail, Brain, Zap, Rocket];
