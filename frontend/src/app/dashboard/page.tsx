...
/** Read body once; JSON.parse or surface raw text (avoids "Unexpected token" when the server returns plain text). */
async function readApiJsonBody<T extends object>(res: Response): Promise<T> {
...
async function fetchAlgorandSuggestedParams(): Promise<{
